...
const WA = "https://wa.me/917011402167?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20the%20Pet%20Recall%20Engine";
...
const mechanisms = [
  { title: "Recall", desc: "Every pet whose last-visit-date plus vaccination, deworming, or checkup interval is due gets a WhatsApp message before the window opens." },
  { title: "No-Show Re-Engagement", desc: "Every no-show or cancellation automatically triggers a WhatsApp re-booking message. No receptionist has to remember to follow up." },
  { title: "Review Capture", desc: "Every completed visit gets a WhatsApp review request 24 hours later, while the owner still remembers how it went." },
];

const steps = [
  { title: "Upload your patient list", desc: "A simple CSV or manual entry: owner name, pet name, WhatsApp number, last-visit-date, service type. No practice-management or booking-system integration required." },
...
const faqs = [
  { q: "Do I need to connect my practice-management software?", a: "No. The Pet Recall Engine runs standalone off a simple patient list. You upload a CSV or enter patients manually: owner name, pet name, WhatsApp number, last-visit-date, service type." },
  ...
  { q: "What exactly happens if I sign up?", a: "We set up your three automations: recall messages timed to each pet's vaccination or checkup cycle, no-show re-booking prompts, and 24-hour post-visit review requests. Nothing beyond those three." },
  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", color: "#18181b", background: "#fff" }}>
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "80px 24px 60px", textAlign: "center" }}>
        <F>
          <div style={{ display: "inline-block", padding: "6px 16px", borderRadius: 20, background: "#f0fdf4", color: "#16a34a", fontSize: 13, fontWeight: 600, marginBottom: 24 }}>Built for Independent Veterinary Clinics in Jakarta</div>
          <h1 style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: -1.5, margin: "0 0 20px" }}>
            The Pet Recall Engine<br />for Veterinary Clinics
          </h1>
          <p style={{ fontSize: 18, color: "#52525b", maxWidth: 620, margin: "0 auto 32px", lineHeight: 1.6 }}>
            Three automated WhatsApp sequences that bring pets back for vaccinations and checkups on schedule, recover no-shows, and collect reviews. Live in 7 days or you pay nothing.
          </p>
      ...
      <section style={{ maxWidth: 800, margin: "0 auto", padding: "72px 24px" }}>
        <F>
          ...
          <p style={{ fontSize: 16, color: "#52525b", lineHeight: 1.7 }}>
            Most independent vet clinics do great medicine and then lose track of the pet anyway. Nobody follows up when a vaccination booster is due. Nobody chases a missed appointment. Nobody asks for a review while the owner is still relieved and grateful.
          </p>
          <p style={{ fontSize: 16, color: "#52525b", lineHeight: 1.7, marginTop: 16 }}>
            You do not need a bigger front desk team or a new practice-management system. You need three messages sent at the right time, every time. That is the whole product.
          </p>
        </F>
      </section>
      ...
      <section style={{ maxWidth: 1000, margin: "0 auto", padding: "72px 24px" }}>
        ...
        <F d={0.1}><p style={{ textAlign: "center", color: "#71717a", marginBottom: 40, fontSize: 15 }}>No practice-management integration. No booking-system sync. Just a patient list and WhatsApp.</p></F>
      ...
      <section style={{ maxWidth: 700, margin: "0 auto", padding: "72px 24px", textAlign: "center" }}>
        <F>
          <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16 }}>Ready to bring pets back on schedule?</h2>
          <p style={{ fontSize: 16, color: "#52525b", marginBottom: 32, lineHeight: 1.6 }}>
            Send us your patient list and we go live within 7 days. If it doesn't lift your repeat bookings in 30 days, you get every rupiah back.
          </p>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <Btn href={WA}>Message Us on WhatsApp <Ic.Arr /></Btn>
            <Btn href={CAL} v="secondary">Book a Demo</Btn>
